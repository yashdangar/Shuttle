            ...
            <div className="flex h-16 items-center gap-x-3 sm:gap-x-4 border-b border-slate-200/60 bg-white/80 supports-[backdrop-filter]:bg-white/60 backdrop-blur px-3 sm:px-6 lg:px-8 shadow-sm">
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <h2 className="truncate text-base sm:text-lg font-semibold tracking-tight text-slate-900">
                      {pageTitle}
                    </h2>
                    <span
              ...
              <div className="flex items-center gap-x-2 sm:gap-x-3">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-72 p-0 overflow-hidden rounded-xl shadow-lg ring-1 ring-black/5"
                  >
                    <div className="relative">
                    ...
                    <DropdownMenuLabel className="px-4 py-2 text-xs uppercase tracking-wide text-slate-500">
                      Account
                    </DropdownMenuLabel>
                    ...
                    <DropdownMenuItem
                      ...
                      className="px-4 text-red-600 focus:bg-red-50 focus:text-red-700"
                    >

...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-screen bg-card border-r shadow-xl transition-all duration-300",
    ...
    >
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-2">
        <Button
          variant="ghost"
          className={cn(
            "w-full justify-start gap-3 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white",

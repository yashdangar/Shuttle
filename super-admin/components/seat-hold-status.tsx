...
import { Clock, AlertCircle, CheckCircle, RefreshCw, Users, Bus, Building } from 'lucide-react';
          ...
          <div className="space-y-3">
            ...
            {booking.guest?.hotel && (
              <div className="flex items-center justify-between text-xs">
                <span className="text-yellow-700">Hotel:</span>
                <span className="font-medium flex items-center space-x-1">
                  <Building className="w-3 h-3" />
                  {booking.guest.hotel.name}
                </span>
              </div>
            )}
            ...
            {isExpired ? (
              ...
              <div className="bg-blue-100 border border-blue-200 rounded p-2">
                ...
                <p className="text-xs text-blue-700 mt-1">
                  This booking has temporarily held seats. Frontdesk verification is pending.
                </p>
              </div>
            )}
          </div>

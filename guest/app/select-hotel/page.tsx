    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Select Your Hotel</h1>
          <p className="text-gray-600">Choose your destination to start booking shuttle rides</p>
        </div>
          ...
          {hotels.map((hotel) => (
            <Card
              ...
              className={`cursor-pointer transition-all ${
                selectedHotel === hotel.id ? "ring-2 ring-blue-500 shadow-lg" : "hover:shadow-md"
              }`}
        ...
        <div className="text-center">
          <Button onClick={handleContinue} disabled={!selectedHotel} size="lg" className="px-8">
            Continue to Booking
          </Button>
        </div>
      </div>

...
const roleScopes: Record<Role, string[]> = {
  ...
  frontdesk: ["/frontdesk","/frontdesk/drivers","/frontdesk/frontdesks","/frontdesk/shuttles","/frontdesk/current-trips","/profile","/notifications","/chat","/frontdesk/trips"  ],
...
export const config = {
  matcher: [
    "/((?!api|_next/static|_next/image|_next/data|sounds|favicon.ico|robots.txt|sitemap.xml|manifest.json|.*\\.(?:svg|png|jpg|jpeg|gif|webp|mp3|wav|ogg)$).*)",
  ],
};

...
export function CreateFrontdeskDialog() {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      setRequestError(error.message ?? "Failed to create frontdesk user");
    }
  };
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Add Frontdesk</DialogTitle>
          <DialogDescription>
            Create a new frontdesk staff member to manage daily operations.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form

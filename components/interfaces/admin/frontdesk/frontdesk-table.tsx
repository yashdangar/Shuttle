...
import { EditFrontdeskDialog } from "./edit-frontdesk-dialog";
import {
  Table,
  TableBody,
  TableCell,
...
export function FrontdeskTable() {
  ...
  const [userToDelete, setUserToDelete] = useState<FrontdeskAccount | null>(
    null
  );
  ...
  const handleDeleteRequest = (user: FrontdeskAccount) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setDeleteError(error.message ?? "Failed to delete frontdesk user");
    } finally {
